...
workflow {
      ...
      if ( params.variants ) {
        ...
        assembly = RNASEQ_GATK_RECALIBRATE.out.groupTuple()
      } else {
        log.info "No known --variants provided, skipping Base Queality Score Recalibration."
        assembly = RNASEQ_GATK_SPLITNCIGAR.out.groupTuple()
      }
